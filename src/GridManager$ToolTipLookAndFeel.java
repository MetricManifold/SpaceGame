...
/*     */   {
/* 117 */     super.initSystemColorDefaults(table);
/* 118 */     table.put("info", new ColorUIResource(200, 200, 200));
/*     */   }
/*     */   
/*     */   protected void initComponentDefaults(UIDefaults table) {
/* 122 */     super.initComponentDefaults(table);
/*     */     
/* 124 */     Border border = BorderFactory.createLineBorder(new Color(76, 79, 83));
/* 125 */     table.put("ToolTip.border", border);
/*     */   }
/*     */ }
