 ...
 public class TurnManager
 {
   ...
   public void ShipBattle(int x)
   {
     ...
     else
     {
       ...
       int attackdefense = (int)((planetships[this.Destination[x]] - this.Frigates[x] * 10) * (1.0D + planetstrength[this.Destination[x]] / 20.0D * Math.pow(0.9D, this.Destroyers[x])));
       int shipdefense = (int)(planetstrength[this.Destination[x]] * (b.destroyer[this.Destination[x]] * 0.08D + b.frigate[this.Destination[x]] * 0.04D + b.fighter[this.Destination[x]] * 0.01D));
   ...
   public String[] GetPlanetOwner() { return this.planetowner; }
   
   public String[] GetPlanetName() {
     return this.planetname;
   }
   
   public int[] GetPlanetShips() { return this.planetships; }
   
   public int[] GetPlanetProd() {
     return this.planetproduction;
   }
   
   public double[] GetPlanetStrength() { return this.planetstrength; }
   ...
   public void SetPlanetOwner(String[] owner) { this.planetowner = owner; }
   
   public void SetPlanetName(String[] name) {
     this.planetname = name;
   }
   
   public void SetPlanetShips(int[] ships) { this.planetships = ships; }
   
   public void SetPlanetProd(int[] production) {
     this.planetproduction = production;
   }
   
   public void SetPlanetStrength(double[] strength) { this.planetstrength = strength; }
   
   public void SetPlanetCredits(int[] credits) {
     this.planetcredits = credits;
   }
   
   public void SetFirstTurn(boolean turn) { this.FirstTurn = turn; }
 }
